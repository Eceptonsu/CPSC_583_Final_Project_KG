...
models = ['CP', 'ComplEx', 'TransE', 'RESCAL', 'TuckER', 'RotatE', 'UniBi_3']
parser.add_argument(
...
parser.add_argument('--rel_norm', action='store_true')
parser.add_argument('--ent_norm', action='store_true')

regularizers = ['N3', 'F2', 'DURA_UniBi_2', 'DURA_UniBi_3']
parser.add_argument(
...
parser.add_argument(
    '--set_scheduler', default=None, type=str, 
    help='select scheduler for learning rate'
)
parser.add_argument(
...
parser.add_argument(
    '--run_names', default='temp', type=str,
)
parser.add_argument(
